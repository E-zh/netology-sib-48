...
3. Далее конкатенируем значение в `100000Подарочная карта на 1000 рублей10001TopSecretTerminalKey`
4. Вычисляем хэш `sha256` из строки, который и будет являться токеном:
    ```shell
    $ echo '100000Подарочная карта на 1000 рублей10001TopSecretTerminalKey' | openssl dgst -sha256
    SHA2-256(stdin)= 477608d40564b486b3570a6bbe2fce09c324b57d35026923e588ff40d080f3c4
    ```
   
Ответ на задание: Token - `477608d40564b486b3570a6bbe2fce09c324b57d35026923e588ff40d080f3c4`
