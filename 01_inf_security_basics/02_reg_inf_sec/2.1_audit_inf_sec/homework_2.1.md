...
- [ ] Изучен разбор кейса [«Как определить активы организации в контенте ИБ»](assets/casestudy_company_assets.md).
- [ ] Изучены дополнительные материалы к занятию.
      
## Инструкция к заданию

1. Внимательно прочитайте все задания и вопросы к ним
2. Скачайте [Шаблон домашнего задания](assets/Аудит_информационной_безопасности.docx) на своё устройство (скачивание начнётся автоматически при нажатии на ссылку документа).
